...
## [2026-06-28] update | Index synced 57→60 skills. 3 new skills added (kindle-manga, manga-anime-data, threejs-rendering-debug). 16 size entries updated (messaging-platforms +7095, iaf-newsletter-pipeline +8864, process-augmentation-pipeline +6437, simplify-code +2674, skills-repo-curator +806, google-workspace +1368, style-guide-consultation +577, vercel-deploy +343, oracle-host-access +199, read-reddit -190, pi-session-audit +206, data-pipeline-patterns +192, gemini-rate-limit-backoff +36, augmentacao-query +1, augmentation-process-design -71, bpmn-diagram-renderer +160, improve-codebase-architecture +158). 16 descriptions fixed — paragraphs added with "Load this skill when" trigger to hephaistos*, messaging-platforms, pi-session-audit, style-guide-consultation, data-pipeline-patterns, gemini-rate-limit-backoff, kindle-manga, manga-anime-data, google-workspace, read-reddit, augmentacao-query, augmentation-process-design, bpmn-diagram-renderer, improve-codebase-architecture, simplify-code, threejs-rendering-debug. 2 literal \n escapes fixed. 1 unquoted description fixed. 1 Resumo drift fixed. Summary/paragraph descriptions updated in index.md for synced skills. audit-descriptions.py path bug fixed (SKILLS_DIR from script location to skills root). *hephaistos SKILL.md owned by different user (uid 1001), only index.md description updated.
