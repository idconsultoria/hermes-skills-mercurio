...
| `evolve` | Ciclo completo de consolidação (plano → execução → commit) |
...
8. **Atualiza** o index.md pós-transformação
9. **Registra** no log.md com prefixo `evolve`
10. **Stage + commit** final
