...
description: "Surface beliefs, assumptions, and values shaping a system.

Load this skill when deeper mental models need examining with care and evidence. Elicits espoused theories vs theories-in-use, identifies paradigms as deep leverage points, and maps cultural mental models using Senge, Argyris & Schön, and Meadows frameworks."
type: Template
